                                ...
                                {categoryCourses.length > 0 ? (
                                  categoryCourses.map(course => (
                                    <div className="col me-1" key={course.id}>
                                      ...
                                      <Link to={`/coursedetails/${course.id}`} style={{ color: 'black', textDecoration: 'none' }}>  <img src={`http://localhost:8000${course.images}` || side} className="card-img-top" alt={course.title} />
